...
const pluginIDGoFileTemplate = `// Code generated .* DO NOT EDIT.
package main
var manifest = struct {
	PluginID      string
...
const pluginIDJSFileTemplate = `// Code generated .* DO NOT EDIT.
export const pluginId = '%s';
export const pluginVersion = '%s';
`
